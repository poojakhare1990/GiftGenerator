...
public class CollectionDemoActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDemoCollectionPagerAdapter.entryResults=null;
        // Set up action bar.
    ...
    public static class DemoCollectionPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public List<AmazonXmlParser.Entry> entryResults =null;
        ...
        public Fragment getItem(int i) {
           ...
           // args.putInt(DemoObjectFragment.ARG_IMAGE, i + 1); // Our object is just an integer :-P
            args.putString(DemoObjectFragment.ARG_PRICE, entryResults.get(i).price);
            args.putString(DemoObjectFragment.ARG_TITLE, entryResults.get(i).title);
